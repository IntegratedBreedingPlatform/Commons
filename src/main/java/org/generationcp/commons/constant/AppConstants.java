...
public enum AppConstants {
	...
	, CREATE_STUDY_REQUIRED_FIELDS, CREATE_PLOT_REQUIRED_FIELDS, HIDE_STUDY_FIELDS, HIDE_STUDY_VARIABLE_DBCV_FIELDS, HIDE_STUDY_VARIABLE_SETTINGS_FIELDS, HIDE_PLOT_FIELDS, FILTER_STUDY_FIELDS, ID_NAME_COMBINATION, ID_CODE_NAME_COMBINATION_STUDY, BREEDING_METHOD_ID_CODE_NAME_COMBINATION, ID_CODE_NAME_COMBINATION_VARIATE, HIDE_ID_VARIABLES, HIDE_STUDY_DETAIL_VARIABLES, CREATE_STUDY_ENVIRONMENT_REQUIRED_FIELDS, CREATE_STUDY_PLOT_REQUIRED_FIELDS, CREATE_STUDY_EXP_DESIGN_DEFAULT_FIELDS, CREATE_STUDY_REMOVE_TREATMENT_FACTOR_IDS, HIDE_STUDY_ENVIRONMENT_FIELDS, HIDE_STUDY_ENVIRONMENT_FIELDS_FROM_POPUP, DEFAULT_NO_OF_ENVIRONMENT_COUNT, CHECK_VARIABLES, STUDY_BASIC_DETAIL_FIELDS_HIDDEN_LABELS

	, CREATE_STUDY_ENTRY_DETAILS_REQUIRED_FIELDS
	...
	, OBJECTIVE_ID, OCC, STUDIES, CROSS_PLAN
